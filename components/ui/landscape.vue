  ...
  <section>
    ...
    <v-row id="landscape">
      <v-col class="d-none d-sm-flex align-center justify-center">
        <img
          id="landscape__illustration"
          src="/assets/img/developer-activity-animate.svg"
          style="width: 100%"
        />
      </v-col>
      <v-col
        cols="auto"
        class="d-flex flex-column align-sm-end justify-center ga-6"
      >
        <img
          v-if="theme.isDark"
          src="/assets/img/df-light.svg"
          style="width: 25%"
          class="d-none d-sm-block"
        />
        <img
          v-else
          src="/assets/img/df-dark.svg"
          style="width: 25%"
          class="d-none d-sm-block"
        />
